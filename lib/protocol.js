 ...
 */
  ...
  Package.TYPE_HANDSHAKE = 1;       //服务器第一次握手  发送版本信息
  Package.TYPE_HANDSHAKE_ACK = 2;   //客户端确认连接成功
  Package.TYPE_HEARTBEAT = 3;       //客户端心跳包
  Package.TYPE_DATA = 4;            //接受到数据包
  Package.TYPE_KICK = 5;            //踢下线
